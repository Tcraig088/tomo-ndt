...
from tomondt.depreciated.utils.widgets import GroupBoxWidget
from tomondt.depreciated.napari.widgets.operation_widgets import SimulateWidget, AlignWidget, ProjectionWidget, PluginFunctionWidget
